# ![ManzaiShow](http://cdn.pocketmine.net/img/PocketMine-MP-h.png)
...
# This is a third-party PM build called ManzaiShow, which only stabilizes plugin and item support, not much else.
